...
<head>
    ...
    <?= $this->Html->css(array('custom/bootstrap.min.css', 'custom/font-awesome.min.css', 'custom/ionicons.min.css', 'custom/AdminLTE.min.css', 'custom/_all-skins.min.css','custom/jquery-jvectormap.css', 'custom/bootstrap-datepicker.min.css', 'custom/daterangepicker.css', 'custom/bootstrap3-wysihtml5.min.css', 'custom/dataTables.bootstrap.min.css')) ?>
...
<!-- <script src="https://cdn.ckeditor.com/4.13.0/standard/ckeditor.js"></script><script>
  $(function () {
